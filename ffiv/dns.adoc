...
create ltm virtual vs_1 destination 10.1.10.20:80 ip-protocol tcp pool http_pool_1 

// vs 2
create ltm pool http_pool_2 members add { 10.1.20.14:80 { address 10.1.20.14 } 10.1.20.15:80 { address 10.1.20.15 } }
create ltm virtual vs_2 destination 10.1.10.21:80 ip-protocol tcp pool http_pool_2

// verify vs 1 and 2
curl http://10.1.10.20/hello
curl http://10.1.10.21/hello
----
...
// create ltm server
create gtm server BJ_DC_LTM datacenter BJ_DC devices add { ltm.example.com { addresses add { 10.1.10.245 } } } monitor bigip virtual-servers add { service_vs_1 { destination 10.1.10.20:80 } service_vs_2 { destination 10.1.10.21:80 } } 
