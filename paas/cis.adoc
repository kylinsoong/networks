...
k8s-bigip-ctlr-deployment-7b869df6b6-fnqwt   1/1   Running   0     90s   192.168.251.33   machine02.example.com
----
...
// create
kubectl create -f mysql.yaml -n bigip-ctlr

// create svc
kubectl expose deployment mysql --port=3306 --target-port=3306 --name=mysql-svc -n bigip-ctlr
